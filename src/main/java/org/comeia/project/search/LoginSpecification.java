...
public class LoginSpecification {
	...
	public static Specification<Login> listAllByCriteria(List<SearchCriteria> criterias) {
	...
	private static List<Predicate> addPredicates(
			List<SearchCriteria> criterias, Root<Login> root,
	...
	private static void addPredicate(Root<Login> root, CriteriaBuilder builder, 
